...
public class Game_Screen3 implements Screen {
	...
	public Game_Screen3(int chiso, int tg, int themtnt) {
		player = new Player(300, 24);
		dem = tg > 0 ? tg : 40;
		Player.moc.setChiso_Diem(chiso);
		
		// NẠP ĐẦY ĐỦ TRẠNG THÁI TỪ GAME_MANAGER
	...
	private void loadResources() {
		try {
			// Vật phẩm, tăng độ khó: thêm đá, thêm vàng ở vị trí khó hơn
			...
			listGold.add(new Gold(350, 200, "Resources/vang_3.png", 200, 3)); // vàng ở vị trí khó hơn

			listDa.add(new Da(250, 390, "Resources/da_2.png", 20, 2));
			listDa.add(new Da(660, 250, "Resources/da_2.png", 15, 2));
			listDa.add(new Da(400, 350, "Resources/da_2.png", 25, 2)); // thêm đá
			...
			listKc.add(new kim_cuong(150, 400, "Resources/kc.png", 500)); // thêm kim cương
			listThung.add(new thung(500, 350));

			// Thêm hàm răng (nhiều hơn và khó hơn)
			listHamRang.add(new HamRang(100, 150, 2)); // Di chuyển nhanh sang phải
			listHamRang.add(new HamRang(400, 250, -1)); // Di chuyển sang trái
			listHamRang.add(new HamRang(700, 350, 1)); // Di chuyển sang phải
